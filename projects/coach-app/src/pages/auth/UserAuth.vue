	...
	<div>
		...
		<BaseCard>
			<form @submit.prevent="submitForm">
				...
				<p v-if="!formIsValid">
					Please enter a valid email and password of at least 6
					characters
				</p>
	...
	methods: {
		async submitForm() {
			...
			try {
                ...
                const redirectLocation = (this.$route.query.redirect || 'coaches')
                this.$router.replace({name: redirectLocation})
			} catch (e) {
