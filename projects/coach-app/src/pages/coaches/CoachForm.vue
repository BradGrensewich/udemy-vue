	...
	<form @submit.prevent="submitForm">
		<div class="form-control" :class="{ invalid: !firstName.isValid }">
			...
			<input
				type="text"
				id="firstname"
				v-model.lazy.trim="firstName.val"
		...
		<div class="form-control" :class="{ invalid: !lastName.isValid }">
			...
			<input
				type="text"
				id="lastname"
				v-model.lazy.trim="lastName.val"
		...
		<div class="form-control" :class="{ invalid: !description.isValid }">
			...
			<textarea
				id="description"
				rows="10"
				v-model.lazy.trim="description.val"
		...
		<p v-if="!formIsValid">Please enter valid input in the above fields</p>
